            ...
            <>
                ...
                <Row className="mb-4">
                    <Col xs="12">
                        ...
                        Digite su correo electrónico y usuario para recuperar contraseña
                        </p>
                    </Col>
                </Row>
                <Row>
                    <Form layout="vertical" >
                        ...
                        <Form.Item>
                            <Row gutter={10}>
                                ...
                                <Col span={12}>
                                    <Button className="main-text fw-bold" style={{ borderWidth:'2px'}} size="large" htmlType="button" type="primary" ghost block onClick={() => navigate("/recovery-account")}>
                                    Regresar
                                    </Button>
                                </Col>
                            </Row>
