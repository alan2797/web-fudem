...
const configFormSchema: FieldConfig<ForgotUsernameRequestDto>[] = configFormForgotUsername();
const forgotUsernameSchema = generateZodSchema<ForgotUsernameRequestDto>(configFormSchema);
            ...
            {!mostrarConfirm ? (
                <>
                    ...
                    <Row className="mb-4">
                        <Col xs="12">
                            ...
                            Digite su correo electrónico para que le enviemos el nombre de su usuario
                            </p>
                        ...
                        <Col xs={24}>
                            <Form layout="vertical" onFinish={handleSubmit(onSubmit)}>
                                ...
                                <Form.Item>
                                    <Row gutter={10}>
                                        <Col span={12}>
                                            <Button size="large" type="primary" htmlType="submit" block onClick={() => setMostrarConfirm(true)}
                                        ...
                                        <Col span={12}>
                                            <Button className="main-text fw-bold" style={{ borderWidth:'2px'}} size="large" htmlType="button" type="primary" ghost block onClick={() => {
                ...
                <Row>
                    <Row className="mb-3" justify="center" align="middle">
                        ...
                        >
                            <CheckOutlined size={30} className="fs-4" style={{color:'#00C473'}} />
                        </Col>
                        <Col xs="12">
                            <p className="text-center fs-6">
                            <span className="fw-bold">¡Listo!</span> Tu nombre de usuario fue enviado a tu correo. Revisa tu bandeja de entrada o la carpeta de spam.
                            </p>
                        </Col>
                    </Row>
                    <Button className="fw-bolder" size="large" htmlType="button" type="primary" block onClick={() => {
