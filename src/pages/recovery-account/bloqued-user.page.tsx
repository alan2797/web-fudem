  ...
  return (
    <Row className="min-vh-100 d-flex justify-content-center align-items-center" style={{ backgroundColor: token.colorPrimary }} >
      <Col xs={24} lg={10} className="d-flex justify-content-center">
        <Card className="w-100" style={{ maxWidth: 410, borderRadius: 24 }} styles={{ body: { padding: "2rem" }}} >
            ...
            <>
                ...
                <Row className="mb-4">
                    <Col xs="12">
                        ...
                        Digite su correo electrónico y usuario para poder desbloquear su usuario
                        </p>
                    </Col>
                </Row>
                <Row>
                        ...
                        <Row>
                            ...
                            <Col span={24}>
                                <Form.Item
                                    ...
                                    name='email'>
                                    <Input size="large" placeholder="ej. juliana@fudem.com" />
                                </Form.Item>
                            </Col>
                        </Row>
                        <Form.Item>
                            <Row gutter={10}>
                                ...
                                <Col span={12}>
                                    <Button className="main-text fw-bold" style={{ borderWidth:'2px'}} size="large" ghost  htmlType="button" type="primary" block onClick={() => navigate("/recovery-account")}>
                                    Regresar
                                    </Button>
                                </Col>
                            </Row>
                ...
                <Row>
                    <Row className="mb-3" justify="center" align="middle">
                        ...
                        <Col xs="12">
                            ...
                            <span className="fw-bold">Su información ha sido validado,</span> se ha enviado una contraseña temporal, por favor revise su correo
                            </p>
                        </Col>
                    </Row>
