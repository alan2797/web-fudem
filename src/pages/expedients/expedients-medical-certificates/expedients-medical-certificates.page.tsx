import {CheckOutlined, DeleteOutlined, EyeOutlined, PlusCircleOutlined, SolutionOutlined } from "@ant-design/icons";
...
import {
  configForm,
  mockData,
} from "./configs/expedients-medical-certificates.config";
...
import { columns } from "./configs/expedients-medical-certificates-table.config";
...
const ExpedientsMedicalCertificates: React.FC = () => {
  ...
  return (
    <PageContainer
      title="Constancias"
      icon={<SolutionOutlined className="fs-2" />}
    >
      <Row>
        <Col span={24}>
          <Divider />
      ...
      <ModalConstanciaMedica
        ...
        icon={<SolutionOutlined className="fs-2 text-primary-antd" />}
         footerButtons={[
            {
              text: "Limpiar",
              type: "primary",
...
export default ExpedientsMedicalCertificates;
